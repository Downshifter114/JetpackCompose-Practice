...
fun DarkMode() {
    ...
    CustomTheme(enableDarkMode = enableDarkMode) {
        ThemedDrawerAppComponent(enableDarkMode = enableDarkMode)
    }
}
...
fun ThemedScreen1Component(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Surface(modifier = Modifier.weight(1f), color = MaterialTheme.colors.surface) {
            Text(
                text = "Something something happening it is something isn't it?",
                style = MaterialTheme.typography.body1.copy(color = MaterialTheme.colors.onSurface),
...
fun ThemedScreen2Component(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Surface(modifier = Modifier.weight(1f)) {
            Text(
                text = "Ayy lmao means ayyyyyy lmao as in like ay lmao", style = MaterialTheme.typography.body1,
                modifier = Modifier.padding(16.dp)
            )
        }
    }
...
fun ThemedScreen3Component(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Surface(modifier = Modifier.weight(1f)) {
            Text(
                text = "Kinda getting out of ideas now, why'd you do this?", style = MaterialTheme.typography.body1,
                modifier = Modifier.padding(16.dp)
            )
        }
    }
